...
output "send_notification_artifact_parameter_name" {
  value       = var.create_artifact_parameter ? aws_ssm_parameter.send_notification_artifact[0].name : null
  description = "SSM parameter name storing send-notification artifact metadata."
}
